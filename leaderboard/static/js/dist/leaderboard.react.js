...
module.exports = {
  keys: {},
  set: function set(key, url, preprocessor) {
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/cachedfetch.js","/")
},{"+7ZJp0":12,"buffer":10}],2:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";

module.exports = {
  fire: function fire(eventName, eventData) {
...
var Leaderboard = React.createClass({
  ...
  render: function render() {
    ...
    if (this.state.selection.profile != null) {
      content = React.createElement(LeaderProfile, {
        selection: this.state.selection
      });
    } else {
      content = React.createElement(LeaderTable, {
        selection: this.state.selection
      });
    }
    ...
    return React.createElement(
      "div",
      { id: "leaderboard", className: "section" },
      React.createElement(
        "div",
        { className: "col span_8_of_12" },
        map
      ),
      React.createElement(
        "div",
        { className: "col span_4_of_12" },
        content
      )
    );
  },

  updateWindowLocation: function updateWindowLocation(selection) {
  ...
  getLeadersUrl: function getLeadersUrl(selection) {
  ...
  loadLeadersData: function loadLeadersData(selection) {
    var leadersUrl = this.getLeadersUrl(selection);
    return cachedFetch.set(getLeadersKey(selection), leadersUrl);
  },

  loadProfileData: function loadProfileData(selection) {
  ...
  handleUpdateSelection: function handleUpdateSelection(selection) {
    var _this = this;
...
module.exports = {
  init: function init(config) {
    ...
    ReactDOM.render(React.createElement(Leaderboard, { config: config }), document.getElementById("leaderboard-container"));
  }
};
...
var tilesUrl = "https://{s}.tiles.mapbox.com/v4/mozilla-webprod.g7ilhcl5/{z}/" + "{x}/{y}.png?access_token=pk.eyJ1IjoibW96aWxsYS13ZWJwcm9kIiwiYSI6Im5ZW" + "UpCb3MifQ.06LZyRt2m_MlRKsKU0gBLA";

var mapAttribution = "<a href=\"https://www.mapbox.com/about/maps\">© Mapbox</a> " + "<a href=\"http://openstreetmap.org/copyright\">© OpenStreetMap</a>" + "<a href=\"http://mapbox.com/map-feedback/\" class=\"mapbox-improve-map\">" + "Improve this map</a>";
...
var LeaderMap = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    this.mapReady = Promise.all([javascriptLoaded, geoJsonLoaded, countriesInfoLoaded]).then(function (results) {
      var countriesGeo = results[1];
      var countriesInfo = results[2];

      _this.map = L.map("leaders-map", {
        closePopupOnClick: true,
        maxBounds: L.latLngBounds(L.latLng(-85.0511, -190.0), L.latLng(85.0511, 190.0))
      }).setView([30, 0], 2);
      ...
      _this.popup = L.popup().setLatLng(L.latLng(20, 0)).setContent(popupContent).openOn(_this.map);

      var onEachFeature = function onEachFeature(countryShapeInfo, layer) {
        var countryIso2 = countryShapeInfo.properties.alpha2;
        var countryHasData = countriesInfo[countryIso2] !== undefined;

        _this.countryLayers[countryIso2] = layer;
  ...
  updateSelectedCountry: function updateSelectedCountry(oldSelection, newSelection) {
    var _this2 = this;

    this.mapReady.then(function () {
      var oldSelectedLayer = _this2.countryLayers[oldSelection.iso2];
  ...
  render: function render() {
    return React.createElement(
      "div",
      null,
      React.createElement("link", { rel: "stylesheet", href: this.props.leafletCSSUrl }),
...
var LeadersHeader = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    cachedFetch.get("countriesInfo").then(function (countriesInfo) {
      _this.setState({ countries: countriesInfo });
    });
  },
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "select",
          { value: selection.iso2, onChange: this.handleChange },
          React.createElement(
            "option",
            { value: "" },
            "All Countries"
...
var LeadersFooter = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "col span_3_of_12" },
        React.createElement(LeadersButton, {
          name: "Previous",
      ...
      React.createElement(
        "div",
        { className: "center col span_6_of_12" },
        React.createElement(
          "span",
          null,
          this.props.start,
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "td",
        null,
        this.props.leader.observations
      )
    );
  }
});
...
var LeaderTable = React.createClass({
  ...
  loadData: function loadData(selection) {
    var _this3 = this;
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/parseurl.js","/")
},{"+7ZJp0":12,"buffer":10}],9:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../../node_modules/base64-js/lib/b64.js","/../../../node_modules/base64-js/lib")
},{"+7ZJp0":12,"buffer":10}],10:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"+7ZJp0":12,"base64-js":9,"buffer":10,"ieee754":11}],11:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"+7ZJp0":12,"buffer":10}],12:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"+7ZJp0":12,"buffer":10}],13:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
var ES6Promise = _dereq_('es6-promise').Promise,
  checkGlobal = _dereq_('./lib/checkGlobal'),
  doc = global.document,
  cached = {};
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../../node_modules/promisescript/index.js","/../../../node_modules/promisescript")
},{"+7ZJp0":12,"./lib/checkGlobal":14,"buffer":10,"es6-promise":15}],14:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../../node_modules/promisescript/lib/checkGlobal.js","/../../../node_modules/promisescript/lib")
},{"+7ZJp0":12,"buffer":10}],15:[function(_dereq_,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
}).call(this,_dereq_("+7ZJp0"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},_dereq_("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../../../node_modules/promisescript/node_modules/es6-promise/dist/es6-promise.js","/../../../node_modules/promisescript/node_modules/es6-promise/dist")
},{"+7ZJp0":12,"buffer":10}]},{},[3])
(3)
});